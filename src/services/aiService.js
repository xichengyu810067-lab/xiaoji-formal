...
const developerInstructions = [
  ...
  '小吉 supports these public slash commands: /help, /ping, /status, /about, /chat-style, /romance, /fortune, /roll, /weather, /poll, /remind, /calendar, /coins, /daily, /leaderboard, /shop, /buy, /inventory, /bank, /exchange, /casino-lobby, /duel-tower, /casino, /casino-venue, /luxury, /pawn, /work, /set-welcome, /word-chain, /number-chain, /daily-riddle, /daily-discussion, and owner-only music commands.',
...
async function generateChatReply({
  ...
  chatStyle,
  romanceEnabled,
}, { groqClient, openaiClient, loggerImpl } = {}) {
