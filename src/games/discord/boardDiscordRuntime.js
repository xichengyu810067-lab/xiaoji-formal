...
const { BoardSessionService } = require('../boardSessionService');
const { createBoardLifecycle } = require('../boardLifecycle');
const { BoardCoreError } = require('../contracts');
const { BoardEngineRegistry } = require('../engineRegistry');
  ...
  async function executeCommand(interaction) {
    try {
      ...
      if (action === 'start') {
        ...
        return await bindInitialMessage(interaction, started);
      }
